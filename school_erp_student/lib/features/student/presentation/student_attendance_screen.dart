...
class _StudentAttendanceScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (studentId.isNotEmpty) {
        ref.read(attendancePageProvider.notifier).loadAttendance(studentId);
      }
    });
  }
          ...
          child: Column(
            ...
            children: [
              overviewAsync.when(
                ...
                data: (summary) => _overallCard(context, summary),
              ),
  ...
  Widget _overallCard(BuildContext context, AttendanceSummary summary) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                _statRow('Total Days', summary.total, AppColors.textPrimary),
              ],
            ),
          ),
        ],
  ...
  Widget _statRow(String label, int value, Color color) {
    return Row(
      children: [
        ...
        Text('$label: $value', style: TextStyle(color: color, fontSize: 13)),
      ],
    );
  }
