...
import 'package:school_erp_teacher/core/api/security_client_default.dart'
    if (dart.library.io) 'package:school_erp_teacher/core/api/security_client_io.dart';
...
import 'package:school_erp_teacher/features/auth/data/auth_repository.dart';
    ...
    try {
      ...
      if (!user.isTeacher) {
        state = state.copyWith(
          ...
          errorMessage: 'Access denied. Teacher credentials required.',
        );
        return;
      }
